...
![](images/clipboard-3123546023.png)

The default field name is messy, hence we will rename it to accHansen by using the code chunk below.

```{r}
colnames(acc_Hansen) <- "accHansen"
```

![](images/clipboard-2905154071.png)

The field name is tidier now.
...
A single code chunk that can replace the above is as below:
